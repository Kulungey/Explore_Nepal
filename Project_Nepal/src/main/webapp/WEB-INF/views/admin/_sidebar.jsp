...
<c:set var="isBookings"  value="${param.activePage == 'bookings'}"/>
<c:set var="isUsers"     value="${param.activePage == 'users'}"/>
...
<aside class="admin-sidebar">
  ...
  <div class="sidebar-section-label" style="margin-top:var(--sp-2);">Orders</div>

  <a href="${pageContext.request.contextPath}/admin/bookings"
     class="sidebar-link ${isBookings ? 'sidebar-link--active' : ''}">
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
         stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <div class="sidebar-section-label" style="margin-top:var(--sp-2);">Users</div>

  <a href="${pageContext.request.contextPath}/admin/users"
     class="sidebar-link ${isUsers ? 'sidebar-link--active' : ''}">
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
         stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
